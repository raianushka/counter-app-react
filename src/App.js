  ...
  return (
    <div className='w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10' >
      ...
      <div className='flex justify-center bg-white gap-12 py-3 rounded-sm text-[25px] text-[#344151]'>
        ...
        <button  onClick={decreaseHandler} className='border-r-2 text-center border-[#bfbfbf] text-5xl w-20'>
          -
        </button>
        ...
        <button onClick={increaseHandler} className='border-l-2 text-center border-[#bfbfbf] text-5xl w-20'>
          +
        </button>
